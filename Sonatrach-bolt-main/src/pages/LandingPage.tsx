...
*/
import { ArrowRight, CheckCircle2, ClipboardList, Clock, Factory, Gauge, Info, Lock, LockKeyhole, Settings, ShieldCheck, Wrench } from 'lucide-react';
import { AppShell, navigate } from '@/components/Shell';
              ...
              <div className="mt-8 flex flex-col gap-3 sm:flex-row">
                ...
                >
                  Accéder à l'espace de travail <ArrowRight size={17} className="transition group-hover:translate-x-1" />
                                  ...
                                  <a href="#perimetre" className="inline-flex items-center justify-center gap-2 rounded-lg border border-slate-300 bg-white px-6 py-3.5 text-sm font-semibold text-slate-700 transition hover:border-slate-400 hover:bg-slate-50">
          ...
          <div className="grid items-center gap-6 rounded-3xl border border-slate-100 bg-white p-4 shadow-sm lg:grid-cols-[220px_1fr_320px] lg:p-6">
            ...
            <div className="rounded-2xl border border-slate-100 bg-slate-50 p-6">
              ...
              <button
                ...
                className="group mt-3 inline-flex w-full items-center justify-center gap-2 rounded-lg border border-dashed border-slate-400 bg-white px-5 py-3 text-sm font-semibold text-slate-600 transition hover:bg-slate-100"
              >
                <Lock size={16} /> [DEV] Espace admin
              </button>
            </div>
          </div>
        </section>
